/*
 *  kernel_cfg.c
 *  Sun Apr 17 00:05:57 2016
 *  SG Version 2.00
 *  sg.exe mazesolver.oil -os=ECC2 -IC:/cygwin/nxtOSEK/toppers_osek/sg/impl_oil -template=C:/cygwin/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType DisplayTask = 0;
const TaskType MotorControlTask = 1;
const TaskType LeftSensorTask = 2;
const TaskType RightSensorTask = 3;
const TaskType FrontSensorTask = 4;
const TaskType LightSensorTask = 5;

extern void TASKNAME( DisplayTask )( void );
extern void TASKNAME( MotorControlTask )( void );
extern void TASKNAME( LeftSensorTask )( void );
extern void TASKNAME( RightSensorTask )( void );
extern void TASKNAME( FrontSensorTask )( void );
extern void TASKNAME( LightSensorTask )( void );
...
static __STK_UNIT _stack_LeftSensorTask[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_RightSensorTask[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_FrontSensorTask[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_LightSensorTask[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 3, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 4, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 3, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 2, TPRI_MINTASK + 4, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (2) - 1, (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( DisplayTask ), TASKNAME( MotorControlTask ), TASKNAME( LeftSensorTask ), TASKNAME( RightSensorTask ), TASKNAME( FrontSensorTask ), TASKNAME( LightSensorTask ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_DisplayTask, (__STK_UNIT)_stack_MotorControlTask, (__STK_UNIT)_stack_LeftSensorTask, (__STK_UNIT)_stack_RightSensorTask, (__STK_UNIT)_stack_FrontSensorTask, (__STK_UNIT)_stack_LightSensorTask, };
...
const AlarmType cyclic_alarm5 = 4;
const AlarmType cyclic_alarm6 = 5;
...
static void _activate_alarm_cyclic_alarm3( void )
{ (void)ActivateTask( LightSensorTask ); }

DeclareTask(LeftSensorTask);
static void _activate_alarm_cyclic_alarm4( void );
static void _activate_alarm_cyclic_alarm4( void )
{ (void)ActivateTask( LeftSensorTask ); }

DeclareTask(RightSensorTask);
static void _activate_alarm_cyclic_alarm5( void );
static void _activate_alarm_cyclic_alarm5( void )
{ (void)ActivateTask( RightSensorTask ); }

DeclareTask(FrontSensorTask);
static void _activate_alarm_cyclic_alarm6( void );
static void _activate_alarm_cyclic_alarm6( void )
{ (void)ActivateTask( FrontSensorTask ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, 0, 0, 0, 0, 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_cyclic_alarm1, _activate_alarm_cyclic_alarm2, _activate_alarm_cyclic_alarm3, _activate_alarm_cyclic_alarm4, _activate_alarm_cyclic_alarm5, _activate_alarm_cyclic_alarm6, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 50, 100, 100, 50, 50, 50, };
...
const ResourceType sensor_data_manage = 0;
